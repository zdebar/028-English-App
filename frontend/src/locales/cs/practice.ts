export const PRACTICE_TEXTS = {
  ...
  pronunciationPracticeTooltip: 'Procvičit výslovnost vybraných slovíček',
  noPronunciationPracticeSelection: 'Žádná slovíčka nejsou vybrána k procvičování výslovnosti.',
  ...
  pronunciationVocabularyOnly: 'Výslovnost lze procvičovat pouze u slovíček',
