export default function PrivacyPolicy() {
  return (
    <div className="px-2">
      <h1 className=" text-2xl pb-6">Zásady ochrany osobních údajů</h1>
      {/* 1. Osobní údaje, které zpracováváme */}
      <h2>1. Osobní údaje, které zpracováváme</h2>
      <ul>
        <li>
          <b>Údaje pro ověření totožnosti:</b> e-mailová adresa, jméno a
          jedinečný identifikátor účtu poskytovaný službou Google Sign-In.
        </li>
        <li>
          <b>Údaje o účtu:</b> datum vytvoření účtu, datum posledního
          přihlášení.
        </li>
        <li>
      ...
      <table className="mb-4 border w-full text-left text-sm">
        <thead>
          <tr>
            <th>Účel</th>
            <th>Právní základ</th>
      ...
      <p className="text-sm">
        Náš oprávněný zájem spočívá ve zlepšování kvality, přesnosti a
        efektivity výuky.
      </p>
      {/* 3. Analytika */}
      <h2>3. Analytika</h2>
      <ul>
        <li>
          Analyzujeme údaje o procvičování a používání pouze za účelem zlepšení
          funkcí aplikace.
        </li>
        <li>Údaje nepoužíváme pro marketing ani reklamu.</li>
        <li>Analytická data nesdílíme s třetími stranami.</li>
        <li>
          Analytická data jsou využívána pouze v agregované nebo interní podobě.
        </li>
      </ul>
      ...
      <ul>
        <li>
          Osobní údaje uchováváme pouze po dobu existence uživatelského účtu.
        </li>
        <li>
          Po smazání účtu jsou všechny osobní údaje smazány nebo nevratně
          anonymizovány.
        </li>
        <li>
          Anonymizovaná statistická data mohou být uchována za účelem zlepšování
          produktu.
        </li>
      </ul>
      {/* 5. Práva uživatelů */}
