...
function useSkipGestureLock(): readonly [boolean, () => void] {
  ...
  return [isLocked, lockUntilRelease] as const;
}
...
function PracticeControls({
  ...
  const [isSkipGestureLocked, lockHintUntilRelease] = useSkipGestureLock();
