...
export default class AppDB extends Dexie {
  ...
  constructor() {
    ...
    this.version(1).stores({
      user_items:
        '[user_id+item_id], [user_id+started_at], [user_id+grammar_id+started_at], [user_id+updated_at], [user_id+next_at+mastered_at], [user_id+next_at+mastered_at+item_sort_order]',
      grammar: 'id',
