const config = {
  ...
  database: {
    ...
    nullReplacementUserId: 'for all users', // IndexedDB does not support null values in indexes for user_id
  },
  ...
  audio: {
    ...
    startArchives: ['audio_part_1.zip'],
    remainingArchives: ['audio_part_2.zip'],
  },
