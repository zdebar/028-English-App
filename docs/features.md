...
| Google sign-in | Sign in or convert to a durable account. | `GoogleAuthButton`, `ConvertAnonymousUserButton` | Supabase Auth provider flow | Conversion UI is shown from Home for anonymous users. |
